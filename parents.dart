              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  CircleAvatar(
                    ...
                    backgroundColor: Colors.blueGrey[200], // 배경색
                    // backgroundImage: AssetImage('assets/profile_image.png'), // 실제 이미지 사용 시
                  ...
                  // 2. 캘린더, 알람, 게시판, 비상연락 버튼들 (2x2 그리드 형태)
                  Expanded( // 남은 공간 최대한 활용
                    child: GridView.count(
                      ...
                      children: <Widget>[
                        ...
                        _buildFeatureButton(context, Icons.phone, '비상 연락', () {
